...
public static class DbInitializer
{
    ...
    private static async Task EnsureCategoriesAsync(AppDbContext db)
    {
        ...
        {
            ("grooming", "Peluquería", "Grooming", "Baño, corte y estética", "Bath, cut & styling", "/images/categories/cat-grooming-v2.png", "✂️", false, 1),
            ("hotel", "Hotel", "Hotel", "Hospedaje para tu mascota", "Overnight pet boarding", "/images/categories/cat-hotel-v2.png", "🏨", true, 2),
            ("vet", "Veterinario", "Veterinary", "Consultas y cuidados", "Checkups & care", "/images/categories/cat-vet-v2.png", "🩺", false, 3),
            ("daycare", "Guardería", "Daycare", "Guardería diurna", "Daytime pet care", "/images/categories/cat-daycare-v2.png", "☀️", true, 4),
            ("walkers", "Paseadores", "Walkers", "Paseos profesionales", "Professional dog walks", "/images/categories/cat-walkers-v2.png", "🦮", false, 5),
            ("trainers", "Entrenadores", "Trainers", "Entrenamiento", "Training sessions", "/images/categories/cat-trainers-v2.png", "🎓", false, 6)
        };
